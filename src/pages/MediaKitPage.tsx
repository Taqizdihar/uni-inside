      ...
      <main className="relative z-10 pt-32 pb-24 px-6 max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="max-w-2xl mx-auto bg-white/5 border border-white/10 backdrop-blur-xl rounded-3xl p-10 shadow-[0_0_40px_rgba(250,208,44,0.05)]">
            ...
            <div className="text-5xl md:text-7xl font-black text-[#FAD02C] mb-4">5.0k+</div>
            <div className="text-2xl font-bold mb-2">Total Followers</div>
            <p className="text-white/60 leading-relaxed">
              Organically grown audience representing the active and engaged demographic across Telkom University and beyond.
            </p>
          </motion.div>
        </motion.section>
        ...
        >
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { platform: "Instagram", handle: "@uniinside.studio", followers: "2.4K", icon: "IG", growth: "+124%" },
              { platform: "TikTok", handle: "@uniinside", followers: "1.8K", icon: "TK", growth: "+85%" },
              { platform: "YouTube", handle: "Uni-Inside Official", followers: "0.8K", icon: "YT", growth: "+42%" }
            ].map((social, i) => (
              <motion.div 
                key={i} 
                variants={fadeInUp}
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="relative z-10">
            ...
            <div className="flex flex-wrap justify-center gap-5">
              ...
              <button className="px-8 py-4 rounded-full bg-white/10 text-white font-bold hover:bg-white/20 border border-white/20 transition-all flex items-center gap-2">
